...
D3D12_VIEWPORT D3DApp::mScreenViewport;
D3D12_RECT D3DApp::mScissorRect;

int D3DApp::mCurrBackBuffer = 0;
Microsoft::WRL::ComPtr<ID3D12Resource> D3DApp::mSwapChainBuffer[SwapChainBufferCount];
Microsoft::WRL::ComPtr<ID3D12Resource> D3DApp::mDepthStencilBuffer;

Microsoft::WRL::ComPtr<ID3D12Fence> D3DApp::mFence;
UINT64 D3DApp::mCurrentFence = 0;

Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> D3DApp::mRtvHeap;
Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> D3DApp::mDsvHeap;

Microsoft::WRL::ComPtr<ID3D12CommandQueue> D3DApp::mCommandQueue;
Microsoft::WRL::ComPtr<ID3D12CommandAllocator> D3DApp::mDirectCmdListAlloc;

#ifdef _USE_UBER_SHADER
// Uber Shader CommandList
Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList4> D3DApp::mCommandList4;
#else
...
UINT D3DApp::mRtvDescriptorSize = 0;
UINT D3DApp::mDsvDescriptorSize = 0;
UINT D3DApp::mCbvSrvUavDescriptorSize = 0;
	...
	// Enable the D3D12 debug layer.
{
	...
	// 나중에 CommandQ에 명령 리스트를 디스패치 시켰을 때, Complete State를 알아내기 위한 Fence
...
//#endif
	...
	mMultiCommandList4[0]->Close();
	mMultiCommandList4[1]->Close();
	mMultiCommandList4[2]->Close();
#else
	mCommandList->Close();
